...
////        System.out.println("Median is : " + median);
        ...
        List<Integer> listNode = Arrays.asList(1,2,3,4,5);
        ListNode mergedList = new ListNode(listNode.get(0));
        ListNode curr = mergedList;

        for (int i = 1; i < listNode.size(); i++)
        {
            ListNode listItem = new ListNode(listNode.get(i));
            curr.next = listItem;
            curr = curr.next;
        }
        ...
        String lastGeneratedMidSerial = "99999";
        String nextMidSerial = String.valueOf(String.format("%09d",Integer.parseInt(lastGeneratedMidSerial) + 1));

        System.out.println(nextMidSerial);

        String val = "2044OY000200000";
